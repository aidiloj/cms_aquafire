    ...
    <section class="section pt-0">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="mb-8 md:col-6 lg:col-4">
                    <div class="card">
                        <img class="card-img" width="335" height="210" src="images/posts/post-10.png" alt="" />
                        <div class="card-content">
                            <div class="card-tags">
                                <a class="tag" href="#">Development</a>
                            </div>
                ...
                <div class="mb-8 md:col-6 lg:col-4">
                    <div class="card">
                        <img class="card-img" width="335" height="210" src="images/posts/post-11.png" alt="" />
                        <div class="card-content">
                            <div class="card-tags">
                                <a class="tag" href="#">Development</a>
                            </div>
                ...
                <div class="mb-8 md:col-6 lg:col-4">
                    <div class="card">
                        <img class="card-img" width="335" height="210" src="images/posts/post-12.png" alt="" />
                        <div class="card-content">
                            <div class="card-tags">
                                <a class="tag" href="#">Development</a>
                            </div>
                ...
                <div class="mb-8 md:col-6 lg:col-4">
                    <div class="card">
                        <img class="card-img" width="335" height="210" src="images/posts/post-13.png" alt="" />
                        <div class="card-content">
                            <div class="card-tags">
                                <a class="tag" href="#">Development</a>
                            </div>
